...
- [x] 34. 按活动 frame 隔离 Figma iframe 交互 ✅ 2026-08-09
  - [x] 34.1 从桌面 slide 向 `FrameRenderer` 传递 `isActive` ✅ 2026-08-09
  - [x] 34.2 非活动 Figma iframe 禁用 pointer 事件与 Tab 聚焦 ✅ 2026-08-09
  - [x] 34.3 活动 Figma iframe 保持直接点击与内部快捷键能力 ✅ 2026-08-09
  - [x] 34.4 将全部 prototype 的预加载节点前移到进入项目时，并保持跨 tab 挂载 ✅ 2026-08-09
  - [x] 34.5 用 `feed.w/h` 同步锁定首屏 frame 比例并增加舞台骨架 ✅ 2026-08-09
  - [x] 34.6 为图片与 iframe 内容增加加载骨架和淡入切换 ✅ 2026-08-09
- [ ] 35. 保持 L3 和其他 frame 行为不回归
  - [x] 35.1 验证未进入活动 Figma 时 L3 左右、上下与 Alt+数字快捷键正常 ✅ 2026-08-09
  - [x] 35.2 验证非活动 Figma 门控、预加载请求时机和正式 iframe 独立布局 ✅ 2026-08-09
  - [x] 35.3 验证 lint、生产构建与静态导出 ✅ 2026-08-09
  - [ ] 35.4 人工确认 localhost:3000 上 Figma 首次切入等待时间符合预期
