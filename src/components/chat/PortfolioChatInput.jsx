...
import ChatComposer from './PortfolioChatInput/components/ChatComposer';
import ChatPanels from './PortfolioChatInput/components/ChatPanels';
import useChatHistory from './PortfolioChatInput/hooks/useChatHistory';
    ...
    >
      ...
      <div
        className={`relative flex flex-col justify-end overflow-hidden
          rounded-[16px] border-[1px] border-divider
          bg-[hsl(var(--neutral-bg-card)/0.8)] font-system backdrop-saturate-150
          shadow-[0_4px_36px_12px_hsl(var(--neutral-fg-main)/0.1)] backdrop-blur-[24px]
