...
const translations = {
  zh: {
    ...
    chatNicknameTitle: "取个昵称再开始吧",
    chatNicknamePlaceholder: "1~20个字符, 账号基于访问设备记录哦…",
  ...
  en: {
    ...
    chatNicknameTitle: "Choose a nickname to start",
    ...
    commentLikeFailed: "Couldn’t update the like. Please try again",
